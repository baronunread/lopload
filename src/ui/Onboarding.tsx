...
export function Onboarding({ onDone }: OnboardingProps) {
  ...
  const saved = useRef<Connection | null>(null);
        ...
        <AnimatePresence mode="wait" initial={false}>
          {step === "connect" ? (
            ...
            >
              ...
              <m.h1 {...settle(0.2)} className="lopload-heading text-2xl font-semibold">
                That's all!
              </m.h1>
              <m.p {...settle(0.3)} className="lopload-body text-kumo-subtle">
              ...
              <m.div {...settle(0.4)}>
                <Button
                  variant="primary"
                  onClick={() => {
                    if (saved.current) onDone(saved.current);
                  }}
                >
                  Start browsing
                </Button>
